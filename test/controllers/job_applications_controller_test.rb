...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post job_applications_url, params: { job_application: { cv: @job_application.cv, email: @job_application.email, fullname: @job_application.fullname } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { cv: @job_application.cv, email: @job_application.email, fullname: @job_application.fullname } }
