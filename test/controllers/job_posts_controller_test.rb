...
class JobPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_post" do
    assert_difference('JobPost.count') do
      post job_posts_url, params: { job_post: { closing_date: @job_post.closing_date, job_description: @job_post.job_description, job_title: @job_post.job_title } }
    end
  ...
  test "should update job_post" do
    patch job_post_url(@job_post), params: { job_post: { closing_date: @job_post.closing_date, job_description: @job_post.job_description, job_title: @job_post.job_title } }
